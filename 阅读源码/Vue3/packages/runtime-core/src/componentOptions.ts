...
export function applyOptions(instance: ComponentInternalInstance) {
  ...
  // 执行beforeCreate生命周期函数, 并将里面的this指向instance.proxy
  ...
  if (methods) {
    for (const key in methods) {
      ...
      if (isFunction(methodHandler)) {
        ...
        if (__DEV__) {
          // 给instance.ctx定义methods里的方法, 并将里面的this指向instance.proxy
  ...
  if (dataOptions) {
    ...
    // 执行dataOptions, 并将里面的this指向instance.proxy
