...
export class App extends PureComponent {
  ...
  handleSubmit(e) {
    ...
    console.log('简介: ', this.briefRef.current.value)
  ...
  render() {
    const { username, password, isAgree, hobbies, fruit, brief } = this.state
    ...
    return (
      <div>
        <form onSubmit={(e) => this.handleSubmit(e)}>
          ...
          {/* 5.非受控组件的使用 */}
          <input type="text" defaultValue={brief} ref={this.briefRef} />
